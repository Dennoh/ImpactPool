...
public class ThankYouAccessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thank_you_access);
    ...
    private void showDialogPaymentSuccess() {
        ...
        DialogPaymentAccess newFragment = new DialogPaymentAccess();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            startActivity(new Intent(ThankYouAccessActivity.this, MainActivity.class));
            finish();
            startActivity(new Intent(ThankYouAccessActivity.this, MainActivity.class));
        } else {
