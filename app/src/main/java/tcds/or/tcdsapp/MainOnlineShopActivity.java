...
import tcds.or.tcdsapp.mainapp.BrowserActivity;
...
public class MainOnlineShopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardShopNow = findViewById(R.id.cardShopNow);
        ...
        cardShopNow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
