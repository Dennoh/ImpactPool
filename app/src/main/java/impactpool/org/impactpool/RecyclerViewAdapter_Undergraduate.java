...
public class RecyclerViewAdapter_Undergraduate extends RecyclerView.Adapter<RecyclerViewAdapter_Undergraduate.StockViewHolder> {
    ...
    public void onBindViewHolder(final StockViewHolder paramStockViewHolder, final int paramInt) {
        paramStockViewHolder.tvProgramme.setText(productGetters.get(paramInt).getProgramme());
        paramStockViewHolder.tvuniversity.setText(productGetters.get(paramInt).getUniversity());
        paramStockViewHolder.tvMinInstAdmPoints.setText("Min Admission Pnts: " + productGetters.get(paramInt).getMinInstAdmPoints());
        paramStockViewHolder.tvAdmCapacity.setText("Admission Capacity: " + productGetters.get(paramInt).getAdmCapacity());
        paramStockViewHolder.tvProgDuration.setText("Program Duration: " + productGetters.get(paramInt).getProgDuration());
