...
public class Getter_Undergraduate {
    ...
    public Getter_Undergraduate(String id, String programme, String code, String admReq, String minInstAdmPoints, String admCapacity, String progDuration, String university, String region) {
        this.id = id;
        Programme = programme;
        Code = code;
        AdmReq = admReq;
